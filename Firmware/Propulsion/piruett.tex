...
\X52:Initialize watchdog timer\X\Y\par
\fi
...
OC0B (D6), respectivly.
\Y\B\X54:Initialize the Timer Counter 0 for PWM\X\par
\fi
...
\M{50}\B\X50:Initialize Tick timer\X${}\E{}$\6
${}\{{}$\1\6
...
\M{52}\B\X52:Initialize watchdog timer\X${}\E{}$\6
${}\{{}$\1\6
...
\M{54}\B\X54:Initialize the Timer Counter 0 for PWM\X${}\E{}$\6
